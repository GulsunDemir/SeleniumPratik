...
public class C02_RelativeLocatorst {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement adultElectricBicycles = driver.findElement(with(By.tagName("span")).below(hybridBikes));
        System.out.println(adultElectricBicycles.getText());
